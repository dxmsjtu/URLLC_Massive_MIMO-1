...
SUCRe =1; K0values = [100 200 300 500 1000:5000:21000]; %Range of number of inactive UEs in the cell 100 200 300 500 1000:5000:21000
RandomSeed = 0; Kneighboringcells = 10;  SumIndex =0;
Default = 0;

disInterval = 15; % distance interval
nbrOfRAblocks_range =[400];
Chan_range =[1 3];  % 1:Uncorr Rayleigh   2:Corr Rayleigh   3:Los   
M_Appro_range = [0 ];   M_range = [100:50:100];   cellRadius_range =[250:500:250]; pA_range = [1:1]/1000;  taup_range = [10:5:10]; Intra_Cell_Ratio_range =[ 10]/10;
