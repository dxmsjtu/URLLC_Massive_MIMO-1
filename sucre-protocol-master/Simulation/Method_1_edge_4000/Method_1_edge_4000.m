...
nbrOfRAblocks_range =[4000 24000];M_Appro_range = [0 ];   M_range = [100:20:120];   cellRadius_range =[250:500:2250]; pA_range = [1:3]/1000;  taup_range = [10:5:10]; Intra_Cell_Ratio_range =[ 10]/10;
Kneighboringcells_range =[10:2:18];   EdgeRatio_range =[60:20:100]/100;    factor_range = [60:20:100]/100;PL_exp_range =[24:4:38]/1; 
CompRatio_range =[6:2:10]/10;EdgeCompRatio_range =[10:4:24]/10;   shadowFadingStddB_nlos_range = [8:8];  shadowFadingStddB_los_range = [4:4]; RandomAccess_range =[ 3];
...
if plotFig ==1
    filenameTmp ='Method_1_edge_4000';%可将仿真参数作为文件名
    mkdir_str=strcat('.\Simulation\',filenameTmp);
    mkdir(mkdir_str);%一运行就会在当前文件夹下创建simulation文件夹
    ...
    SubCaseNum = 1*12*3;%size(DataMatrix,1) ;    %size(DataMatrix,1);
