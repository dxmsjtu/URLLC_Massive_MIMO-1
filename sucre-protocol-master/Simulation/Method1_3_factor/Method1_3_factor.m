...
clear all; close all;   
filenameTmp ='Method1_3_factor';%factor_ratio_userNum 可将仿真参数作为文件名
...
RandomSeed = 0; Kneighboringcells = 10; nbrOfRAblocks =5000; SumIndex =0;
...
PL_exp_range =[28:4:38]/1; Kneighboringcells_range =[10:2:10];   EdgeRatio_range =[60:10:100]/100;    factor_range = [60:10:100]/100; 
...
if plotFig ==1
    ...
    SubCaseNum = 1*25*3;%size(DataMatrix,1) ;    %size(DataMatrix,1);
