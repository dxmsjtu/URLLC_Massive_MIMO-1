...
clear all; close all;   
filenameTmp ='Method1_32';%factor_ratio_userNum 可将仿真参数作为文件名
...
RandomSeed = 0; Kneighboringcells = 10; nbrOfRAblocks =10000; SumIndex =0;
M_range = [100:50:100];    taup_range = [10 ];
  Default = 0; shadowFadingStddB = 8;
cellRadius_range =[250:500:2250]; pA_range = [1:5]/1000;  Intra_Cell_Ratio_range =[ 10]/10;   
PL_exp_range =[28:4:38]/1; Kneighboringcells_range =[10:2:10];   EdgeRatio_range =[100:10:100]/100;    factor_range = [100:10:100]/100; 
