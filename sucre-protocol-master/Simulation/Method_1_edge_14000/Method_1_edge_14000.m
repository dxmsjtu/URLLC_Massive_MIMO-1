...
clear all; close all;
filenameTmp ='Method_1_edge_14000';%Method_1_3_shadowFadingStddB factor_ratio_userNum 可将仿真参数作为文件名
...
method_range =[2];
nbrOfRAblocks_range =[11330 ];M_Appro_range = [0 ];   M_range = [100:50:250];   cellRadius_range =[250:500:250]; pA_range = [1:1]/1000;  taup_range = [10:5:10]; Intra_Cell_Ratio_range =[ 10]/10;
...
if plotFig ==1
    filenameTmp ='Method_1_edge_14001';%可将仿真参数作为文件名
    mkdir_str=strcat('.\Simulation\',filenameTmp);
                                                                                                       mkdir(mkdir_str);%一运行就会在当前文件夹下创建simulation文件夹
