...
Default = 0;
nbrOfRAblocks_range =[140];M_Appro_range = [0 ];   M_range = [100:50:100];   cellRadius_range =[250:500:250]; pA_range = [1:1]/1000;  taup_range = [10:5:10 ]; Intra_Cell_Ratio_range =[ 10]/10;
PL_exp_range =[38:4:38]/1; Kneighboringcells_range =[10:5:10];   EdgeRatio_range =[60:40:60]/100;    factor_range = [90:10:90]/100;
CompRatio_range =[0:10:10 ]/10; shadowFadingStddB_range = [8:8];  RandomAccess_range =[1 3];
