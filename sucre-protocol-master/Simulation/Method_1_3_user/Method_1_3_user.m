...
clear all; close all;   
filenameTmp ='Method_1_3_user';%factor_ratio_userNum 可将仿真参数作为文件名
...
SUCRe =1; K0values = [100 200 300  500 1000:1000:22000]; %Range of number of inactive UEs in the cell
RandomSeed = 0; Kneighboringcells = 10;  SumIndex =0;
 
  Default = 0; shadowFadingStddB = 8;
nbrOfRAblocks_range =[2000 10000]; M_range = [100:50:100];   cellRadius_range =[250:500:2250]; pA_range = [1:5]/1000;  taup_range = [10:5:30 ]; Intra_Cell_Ratio_range =[ 10]/10;   
PL_exp_range =[30:4:38]/1; Kneighboringcells_range =[10:5:30];   EdgeRatio_range =[100:10:100]/100;    factor_range = [100:10:100]/100; 
CompRatio_range =[10:1:10 ]/10;  RandomAccess_range =[1 2 3];
...
if plotFig ==1
    ...
    SubCaseNum = 1*3*3;%size(DataMatrix,1) ;    %size(DataMatrix,1);
