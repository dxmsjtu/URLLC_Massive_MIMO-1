...
clear all; close all;   
filenameTmp ='Method_1_3_shadowFadingStddB';%factor_ratio_userNum 可将仿真参数作为文件名
...
SUCRe =1; K0values = [100 200 300  500 1000:2000:22000]; %Range of number of inactive UEs in the cell
RandomSeed = 0; Kneighboringcells = 10;  SumIndex =0;
Default = 0; 
nbrOfRAblocks_range =[3300]; M_range = [100:50:100];   cellRadius_range =[250:500:250]; pA_range = [1:1]/1000;  taup_range = [10:5:10 ]; Intra_Cell_Ratio_range =[ 10]/10;   
PL_exp_range =[38:4:38]/1; Kneighboringcells_range =[10:5:10];   EdgeRatio_range =[100:10:100]/100;    factor_range = [100:10:100]/100; 
CompRatio_range =[10:1:10 ]/10; shadowFadingStddB_range = [8:10];  RandomAccess_range =[1 2 3];
...
if plotFig ==1
    filenameTmp ='Method1_32';%可将仿真参数作为文件名
    mkdir_str=strcat('.\Simulation\',filenameTmp);
    mkdir(mkdir_str);%一运行就会在当前文件夹下创建simulation文件夹
