...
clear all; close all;   
filenameTmp ='Method_1';%factor_ratio_userNum 可将仿真参数作为文件名
...
nbrOfRAblocks_range =[10000]; M_range = [100:50:100];   cellRadius_range =[250:500:250]; pA_range = [1:1]/1000;  taup_range = [10:5:10 ]; Intra_Cell_Ratio_range =[ 10]/10;   
PL_exp_range =[38:4:38]/1; Kneighboringcells_range =[10:5:10];   EdgeRatio_range =[100:10:100]/100;    factor_range = [100:10:100]/100; 
CompRatio_range =[10:1:10 ]/10;  RandomAccess_range =[1 ];
