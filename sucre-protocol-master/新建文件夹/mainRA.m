...
SUCRe =1; K0values = [100 200 300  500 1000:5000:20000]; %Range of number of inactive UEs in the cell
RandomSeed = 0; Kneighboringcells = 10; nbrOfRAblocks = 20; SumIndex =0;
 cellRadius_range =[ 250 ];M_range = [100:50:100];  Kneighboringcells_range =[10:5:10]; factor_range = [10:10]/10; EdgeRatio_range =[100:2:100]/100; taup_range = [10 ];  
  pA =0.001;   Default = 0; shadowFadingStddB = 8;
PL_exp_range =[38:2:38]/1;  CompRatio_range =[10 ]/10; 
 RandomAccess_range =[1 2];
Intra_Cell_Ratio_range =[10:10]/10; 
for cellRadius = cellRadius_range;  for M = M_range  for Kneighboringcells =Kneighboringcells_range for factor =  factor_range for EdgeRatio = EdgeRatio_range for taup = taup_range for PL_exp = PL_exp_range
     for Intra_Cell_Ratio =Intra_Cell_Ratio_range             for CompRatio = CompRatio_range
...
SubCaseNum = 9;%size(DataMatrix,1) ;    %size(DataMatrix,1);
PlotRatio = 1*1; StepNum = 3;
...
for i=1:size(DataMatrix,1)/SubCaseNum/PlotRatio;
    ...
    selectedIndex =[1:StepNum:SubCaseNum]
