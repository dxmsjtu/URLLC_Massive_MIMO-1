...
nbrOfRealizations = 200; %  10000 can provide a reliable result£¬ 200  for test;
...
for j = 1:length(neighboringBSs)    
    ...
    interCellVarianceDownlink = interCellVarianceDownlink...,
        + qNeighbor*10.^( (27 + 98.65 - 34.53 - 38*log10(abs(userLocations-neighboringBSs(j))) + shadowFadingStddB_nlos*shadowFadingRealizationsIntercellDownlink(j,:,:)  )/10   );
