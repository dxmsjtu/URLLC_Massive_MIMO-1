...
clear all; close all;
filenameTmp ='test_factor1';%Method_1_3_shadowFadingStddB factor_ratio_userNum 可将仿真参数作为文件名
...
SUCRe =1; K0values = [100 200 300 500 1000:3000:21000]; %Range of number of inactive UEs in the cell 100 200 300 500 1000:5000:21000
...
nbrOfRAblocks_range =[500];M_Appro_range = [0 ];   M_range = [100:50:100];   cellRadius_range =[250:500:250]; pA_range = [1:1]/1000;  taup_range = [10:5:10]; Intra_Cell_Ratio_range =[ 10]/10;
PL_exp_range =[38:4:38]/1; Kneighboringcells_range =[10:5:10];   EdgeRatio_range =[60:10:60]/100;    factor_range = [60:10:60]/100;
CompRatio_range =[10:2:16]/10;EdgeCompRatio_range =[10:2:16]/10;   shadowFadingSt           ddB_nlos_range = [8:8];  shadowFadingStddB_los_range = [4:4]; RandomAccess_range =[ 3];
...
if plotFig ==1
    filenameTmp ='Method_1_3';%可将仿真参数作为文件名
    mkdir_str=strcat('.\Simulation\',filenameTmp);
    mkdir(mkdir_str);%一运行就会在当前文件夹下创建simulation文件夹
    ...
    SubCaseNum = 4*2*3;%size(DataMatrix,1) ;    %size(DataMatrix,1);
