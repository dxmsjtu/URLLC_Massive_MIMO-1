...
% [1] URLLC with Massive MIMO:Analysis and Design at Finite Blocklength
% INPUTS:
% n = blocklength
...
if DEBUG == 1
    ...
    nbrOfRealizations=1e3;    %number of saddlepoint realizations default is 1e5
...
if strcmp(ESTIMATOR, 'MMSE')
    ...
    hhat1 = R1Qinv*yp1; %estimate H1 (28) of [1].
    hhat2 = R2Qinv*yp2; %estimate H2 (28) of [1].
